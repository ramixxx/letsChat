Arguments: 
  /Users/thoover/.nvm/versions/node/v8.9.1/bin/node /usr/local/Cellar/yarn/1.5.1_1/libexec/bin/yarn.js lint:js

PATH: 
  /Users/thoover/.nvm/versions/node/v8.9.1/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/linkedin/bin:/export/content/linkedin/bin:/Users/thoover/code/bin
...
npm manifest: 
  {
    ...
    "repository": "https://github.com/thoov/ember-websockets",
    "scripts": {
      "build": "ember build",
...
Lockfile: 
  ...
  ember-cli-babel@^6.0.0-beta.4, ember-cli-babel@^6.8.2:
    version "6.12.0"
  ...
  semver@^5.1.1, semver@^5.3.0, semver@^5.4.1:
    version "5.4.1"
...
Trace: 
  ...
  Exit code: 1
  Command: sh
  Arguments: -c eslint ./*.js addon addon-test-support app config lib server test-support tests
  Directory: /Users/thoover/code/open-source/ember-websockets
  Output:

...
define("frontend/tests/lint/templates.template.lint-test", [], function () {
  ...
  QUnit.test('frontend/templates/components/chat.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'frontend/templates/components/chat.hbs should pass TemplateLint.\n\nfrontend/templates/components/chat.hbs\n  2:1  error  Incorrect indentation for `{{#if}}` beginning at L2:C1. Expected `{{#if}}` to be at an indentation of 2 but was found at 1.  block-indentation\n  3:1  error  Incorrect indentation for `<div>` beginning at L3:C1. Expected `<div>` to be at an indentation of 3 but was found at 1.  block-indentation\n  12:1  error  Incorrect indentation for `<div>` beginning at L12:C1. Expected `<div>` to be at an indentation of 3 but was found at 1.  block-indentation\n  4:2  error  Incorrect indentation for `<div>` beginning at L4:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  7:2  error  Incorrect indentation for `<div>` beginning at L7:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  5:3  error  Incorrect indentation for `{{item.message}}` beginning at L5:C3. Expected `{{item.message}}` to be at an indentation of 4 but was found at 3.  block-indentation\n  8:7  error  Incorrect indentation for `<img>` beginning at L8:C7. Expected `<img>` to be at an indentation of 4 but was found at 7.  block-indentation\n  19:8  error  Incorrect indentation for `div` beginning at L12:C1. Expected `</div>` ending at L19:C8 to be at an indentation of 1 but was found at 2.  block-indentation\n  13:2  error  Incorrect indentation for `<div>` beginning at L13:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  16:2  error  Incorrect indentation for `<div>` beginning at L16:C2. Expected `<div>` to be at an indentation of 3 but was found at 2.  block-indentation\n  14:7  error  Incorrect indentation for `<img>` beginning at L14:C7. Expected `<img>` to be at an indentation of 4 but was found at 7.  block-indentation\n  17:3  error  Incorrect indentation for `{{item.message}}` beginning at L17:C3. Expected `{{item.message}}` to be at an indentation of 4 but was found at 3.  block-indentation\n  24:1  error  Incorrect indentation for `<form>` beginning at L24:C1. Expected `<form>` to be at an indentation of 2 but was found at 1.  block-indentation\n  25:2  error  Incorrect indentation for `<button>` beginning at L25:C2. Expected `<button>` to be at an indentation of 3 but was found at 2.  block-indentation\n  26:2  error  Incorrect indentation for `{{input}}` beginning at L26:C2. Expected `{{input}}` to be at an indentation of 3 but was found at 2.  block-indentation\n  8:7  error  img tags must have an alt attribute  img-alt-attributes\n  14:7  error  img tags must have an alt attribute  img-alt-attributes\n');
  });
